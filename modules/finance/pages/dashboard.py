...
import os
from modules.finance.utils import load_data, compute_velocity, build_alert_queue, VELOCITY_THRESHOLD
...
with fc1:
    ...
    """, unsafe_allow_html=True)
    st.page_link("modules/finance/pages/alert_queue.py", label="Open Alert Queue →", width="stretch")
...
with fc2:
    ...
    """, unsafe_allow_html=True)
    st.page_link("modules/finance/pages/agent_chat.py", label="Open Agent Chat →", width="stretch")
...
with fc3:
    ...
    """, unsafe_allow_html=True)
    st.page_link("modules/finance/pages/invoice_fraud.py", label="Open Invoice Fraud →", width="stretch")
...
with tab1:
    ...
    with col_btn:
        st.button("Look Up", type="primary", width="stretch")
...
with tab2:
    ...
    if len(selected_ids) < 2:
        ...
        from modules.finance.utils import compare_accounts
